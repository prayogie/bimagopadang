...
<head>
  ...
  <title>Pendaftaran | BIMAGO - padang</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="pendaftaran.php"><i class="fa fa-users"></i> Pendaftaran</a></li>
            <li><a href="alamat.php"><i class="fa fa-map"></i> alamat</a></li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
          ...
          <div class="box col-lg-12">
            <div class="row">
              <div class="box-header">
                ...
                <center><br>
                <h3>
                  Form Pendaftaran <b>Peserta BIMAGO</b> <br>Padang
                </h3>
                <br></center>
              </div>
              <!-- /.col -->
